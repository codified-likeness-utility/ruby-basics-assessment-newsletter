...
def calculate_recipients
  updated_subscribers = (SUBSCRIBERS - UNSUBSCRIBED)
  updated_subscribers
end
...
def print_many_articles
  count = 0
  while count < ARTICLES.length do 
    puts ARTICLES[count][:title]
    puts "by: " + ARTICLES[count][:author]
    puts ARTICLES[count][:text]
    puts nil
    count += 1
  end
end
